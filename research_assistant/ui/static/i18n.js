const messages = {
  vi: {
    ...
    copyFailed: 'Không thể sao chép tự động. Hãy chọn nội dung tệp để sao chép.',
    ...
    researchResults: 'Kết quả nghiên cứu', researchLibrary: 'Thư viện nghiên cứu', outputFiles: 'TỆP ĐẦU RA',
    reviewHere: 'Thư viện nghiên cứu sẽ xuất hiện tại đây',
    reviewDescription: 'Pipeline sắp xếp kết quả thành tổng quan, các phần nội dung, evidence và tài liệu tham khảo.',
    reviewAria: 'Nội dung tài liệu Markdown', researchRuns: 'Các lượt nghiên cứu', refresh: 'Làm mới',
    documentsAria: 'Các tài liệu nghiên cứu', documentListAria: 'Danh sách tài liệu nghiên cứu',
    documentNavigationAria: 'Điều hướng tài liệu', previousDocument: 'Tài liệu trước', nextDocument: 'Tài liệu sau',
    documentMap: 'BẢN ĐỒ TÀI LIỆU', currentDocument: 'TÀI LIỆU ĐANG ĐỌC',
    documentCount: '{count} tệp Markdown', documentIndex: 'Mục lục nghiên cứu', documentOverview: 'Tổng quan',
    documentSection: 'Phần {number}', documentEvidenceIndex: 'Mục lục evidence',
    documentEvidence: 'Evidence {number}', documentReferences: 'Tài liệu tham khảo',
    researchDocuments: 'Tài liệu nghiên cứu', pipelineData: 'Dữ liệu pipeline', runFiles: 'Nhật ký và cấu hình',
    ...
    tabReview: 'Thư viện nghiên cứu', tabLog: 'Nhật ký xử lý',
    tabArtifacts: 'Tệp đầu ra', tabHistory: 'Lịch sử nghiên cứu',
    copyReview: 'Sao chép Review', copyDocument: 'Sao chép tệp', downloadDocument: 'Tải tệp', copied: 'Đã sao chép!',
  ...
  en: {
    ...
    copyFailed: 'Unable to copy automatically. Select the file text to copy it manually.',
    ...
    researchResults: 'Research results', researchLibrary: 'Research library', outputFiles: 'OUTPUT FILES',
    reviewHere: 'Your research library will appear here',
    reviewDescription: 'The pipeline organizes the result into an overview, sections, evidence, and references.',
    reviewAria: 'Markdown document content', researchRuns: 'Research runs', refresh: 'Refresh',
    documentsAria: 'Research documents', documentListAria: 'Research document list',
    documentNavigationAria: 'Document navigation', previousDocument: 'Previous document', nextDocument: 'Next document',
    documentMap: 'DOCUMENT MAP', currentDocument: 'CURRENT DOCUMENT',
    documentCount: '{count} Markdown files', documentIndex: 'Research index', documentOverview: 'Overview',
    documentSection: 'Section {number}', documentEvidenceIndex: 'Evidence index',
    documentEvidence: 'Evidence {number}', documentReferences: 'References',
    researchDocuments: 'Research documents', pipelineData: 'Pipeline data', runFiles: 'Logs and configuration',
    ...
    tabReview: 'Research Library', tabLog: 'Terminal Log',
    tabArtifacts: 'Output Files', tabHistory: 'Research History',
    copyReview: 'Copy Review', copyDocument: 'Copy file', downloadDocument: 'Download file', copied: 'Copied!',
